...
var tugOfWarModel = function(){
    ...
    if (matchInfo.wonngames.length > 0) {
        conditions(0, wonNPreviousGames(matchInfo.wonngames[0].player, 
                                  matchInfo.wonngames[0].nWon, 
                                  matchInfo.wonngames[0].total));
    }
    
if (matchInfo.closegames.length > 0) {
    condition(isClose(matchInfo.games[matchInfo.closegames[0]-1].team1,
                    matchInfo.games[matchInfo.closegames[0]-1].team2,
                    matchInfo.closegames[0]))
}
