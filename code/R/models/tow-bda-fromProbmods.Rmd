...
The posteriors on parameters aren't that compelling. It looks like the model is starting to explore part of the space, but it looks like there's still a bit to explore. Extensions should try to run these chains for longer. An alternative approach would be to return to the discretize + enumerate strategy used before.
...
There is more work to be done here, as outlined above. Interested parties should feel free to contact me if they want to pursue this.
