...
var Config = function (condition, counterbalance) {
    ...
    var maleNamesLength = maleNames.length;
    console.log("Length of names = ", maleNamesLength)
    var usedMaleNames = new Set()
